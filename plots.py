...
def parse_args():
    ...
    p.add_argument("--log_dir", type=str, default="/home/houyh/Pointnet2-for-Directionality-Reconstruction-muon-/experiments/test2/plots")
    p.add_argument("--pred_file", type=str, default="/home/houyh/Pointnet2-for-Directionality-Reconstruction-muon-/experiments/test2/predictions_test.npz")
    return p.parse_args()
